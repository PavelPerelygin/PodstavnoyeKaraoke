...
namespace Utilities.QR
{
    ...
    public class QrCodeGenerator
    {
        ...
        public static Texture2D GetTexture(string text, Color darkColor, Color lightColor, int pixelsPerModule = 20)
        {
            QrCodeGenerator qrGenerator = new QrCodeGenerator();
            QRCode qrCode = qrGenerator.CreateQrCode(text, QrCodeGenerator.ECCLevel.L);
